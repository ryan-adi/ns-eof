...
namespace Stencils {
  ...
  /** Stencil to set periodic boundary conditions for velocity for FGH. Since there are no operations
   * in FGH, this stencil does nothing. WS2
   */
  class PeriodicBoundaryTVStencil: public BoundaryStencil<TurbulentFlowField> {
  public:
    PeriodicBoundaryTVStencil(const Parameters& parameters);
    ~PeriodicBoundaryTVStencil() override = default;
