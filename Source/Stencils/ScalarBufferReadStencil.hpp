...
namespace Stencils {
  ...
  class ScalarBufferReadStencil: public BufferStencil {
  private:
  ...
  public:
    ScalarBufferReadStencil(const Parameters& parameters, ScalarField& scalarField);
    ~ScalarBufferReadStencil() override;
