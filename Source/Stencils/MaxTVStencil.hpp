...
namespace Stencils {
   ...
   */
  class MaxTVStencil: public FieldStencil<TurbulentFlowField>, public BoundaryStencil<TurbulentFlowField> {
  private:
  ...
  public:
    MaxTVStencil(const Parameters& parameters);
    ~MaxTVStencil() override = default;
