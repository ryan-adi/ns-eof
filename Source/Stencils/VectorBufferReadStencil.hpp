...
namespace Stencils {
  ...
  class VectorBufferReadStencil: public BufferStencil {
  private:
  ...
  public:
    VectorBufferReadStencil(const Parameters& parameters, VectorField& vectorField);
    ~VectorBufferReadStencil() override;
