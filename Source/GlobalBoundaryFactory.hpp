...
private:
  ...
  Stencils::BoundaryStencil<TurbulentFlowField>* TVStencils_[6];      //! A stencil for each face
  Stencils::BoundaryStencil<TurbulentFlowField>* KStencils_[6];      //! A stencil for each face
  Stencils::BoundaryStencil<TurbulentFlowField>* WStencils_[6];      //! A stencil for each face
...
public:
  ...
  GlobalBoundaryIterator<TurbulentFlowField> getGlobalBoundaryTVIterator(TurbulentFlowField& flowField); // ws2
  GlobalBoundaryIterator<TurbulentFlowField> getGlobalBoundaryKIterator(TurbulentFlowField& flowField); // ws3
  GlobalBoundaryIterator<TurbulentFlowField> getGlobalBoundaryWIterator(TurbulentFlowField& flowField); // ws3
};
