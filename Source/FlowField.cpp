...
// ------------------------- TurbulentFlowField functions ------------------------ //
// TODO ISSUE probably sizeX_ from FlowField class needs to be 'protected' instead of 'private'
TurbulentFlowField::TurbulentFlowField(const Parameters& parameters):
  FlowField(parameters),
  nearestWallH_(parameters.geometry.dim == 2 ? ScalarField(getNx() + 3, getNy() + 3) : ScalarField(getNx() + 3, getNy() + 3, getNz() + 3)),
  turbViscosity_(parameters.geometry.dim == 2 ? ScalarField(getNx() + 3, getNy() + 3) : ScalarField(getNx() + 3, getNy() + 3, getNz() + 3)),
  turbKineticEnergy_(parameters.geometry.dim == 2 ? ScalarField(getNx() + 3, getNy() + 3) : ScalarField(getNx() + 3, getNy() + 3, getNz() + 3)),
  turbOmega_(parameters.geometry.dim == 2 ? ScalarField(getNx() + 3, getNy() + 3) : ScalarField(getNx() + 3, getNy() + 3, getNz() + 3)),
  turbKineticEnergyRHS_(parameters.geometry.dim == 2 ? ScalarField(getNx() + 3, getNy() + 3) : ScalarField(getNx() + 3, getNy() + 3, getNz() + 3)),
  turbOmegaRHS_(parameters.geometry.dim == 2 ? ScalarField(getNx() + 3, getNy() + 3) : ScalarField(getNx() + 3, getNy() + 3, getNz() + 3)),
  prev_turbKineticEnergy_(parameters.geometry.dim == 2 ? ScalarField(getNx() + 3, getNy() + 3) : ScalarField(getNx() + 3, getNy() + 3, getNz() + 3)),
  prev_turbOmega_(parameters.geometry.dim == 2 ? ScalarField(getNx() + 3, getNy() + 3) : ScalarField(getNx() + 3, getNy() + 3, getNz() + 3)) {}

ScalarField& TurbulentFlowField::getNearestWallH() { return nearestWallH_; }
ScalarField& TurbulentFlowField::getTurbViscosity() { return turbViscosity_; }
ScalarField& TurbulentFlowField::getTurbKineticEnergy() { return turbKineticEnergy_; }
ScalarField& TurbulentFlowField::getTurbOmega() { return turbOmega_; }
ScalarField& TurbulentFlowField::getTurbKineticEnergyRHS() { return turbKineticEnergyRHS_; }
ScalarField& TurbulentFlowField::getTurbOmegaRHS() { return turbOmegaRHS_; }

ScalarField& TurbulentFlowField::getPrevTurbKineticEnergy() { return prev_turbKineticEnergy_; }
ScalarField& TurbulentFlowField::getPrevTurbOmega() { return prev_turbOmega_; }
