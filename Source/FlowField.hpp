...
private:
  ScalarField nearestWallH_;
  ScalarField turbViscosity_;
  ScalarField turbKineticEnergy_;
  ScalarField turbOmega_;
  ScalarField turbKineticEnergyRHS_;
  ScalarField turbOmegaRHS_;

  ScalarField prev_turbKineticEnergy_;
  ScalarField prev_turbOmega_;

public:
  /** Constructs a field from parameters object **/
  TurbulentFlowField(const Parameters& parameters);

  ScalarField& getNearestWallH();
  ScalarField& getTurbViscosity();
  ScalarField& getTurbKineticEnergy();
  ScalarField& getTurbOmega();
  ScalarField& getTurbKineticEnergyRHS();
  ScalarField& getTurbOmegaRHS();

  ScalarField& getPrevTurbKineticEnergy();
  ScalarField& getPrevTurbOmega();
